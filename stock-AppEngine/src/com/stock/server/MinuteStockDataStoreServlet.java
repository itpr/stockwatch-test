...
public class MinuteStockDataStoreServlet extends HttpServlet {
        ...
        public void doGet(HttpServletRequest req, HttpServletResponse resp)
                ...
                try {
                        for(Stock stock : stockDao.getAll()){
                                url = new URL("http://chartapi.finance.yahoo.com/instrument/1.0/"+ stock.getShortName() +"/chartdata;type=quote;range=2d/csv");
								...
								if(matcher.find()){
										...
										quote.setQuoteType(QuoteType.MINUTE);
