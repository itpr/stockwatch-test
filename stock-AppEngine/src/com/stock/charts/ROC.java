...
import com.stock.shared.charts.calculator.ROCCalculator;



public class ROC extends AbstractIndicator<WebPlatform>{

	private static final long serialVersionUID = 6648284819056926160L;

	public ROC(IndicatorsEnum indicatorsEnum, TimePeriod timePeriod, List<QuoteProxy> quotes) {
	...
	private AbstractDataTable createDataTable(){
		...
		List<Double> result = ROCCalculator.calculate(quotes, indicatorsEnum.getPeriod(), timePeriod.getTicks());
