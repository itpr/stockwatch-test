...
import com.stock.shared.charts.calculator.EMACalculator;



public class EMA extends AbstractIndicator<WebPlatform>{

	private static final long serialVersionUID = 6648284819056926160L;

	public EMA(IndicatorsEnum indicatorsEnum, TimePeriod timePeriod, List<QuoteProxy> quotes) {
	...
	private AbstractDataTable createDataTable(){
		...
		List<Double> result = EMACalculator.calculate(quotes, indicatorsEnum.getPeriod(), timePeriod.getTicks());
